        ...
        <div className="container">
          <div className="row" style={{ top: "20%", position: "absolute" }}>
            <div
              ...
              style={{ background: "rgba(0,0,0,0.7)", height: "30vh " }}
            >
      ...
      <div className="container">
        <div className="row mt-4">
          <div className="col-lg-4 col-md-12 h-auto ">
            <div
              className="box-part text-center material-card"
              style={{ height: "17rem" }}
            >
              ...
              <div className="text">
                <span>
                  Book for servicing queue remotely for any service center from
                  anywhere you are and wait for the admin to queue you up
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-4 col-md-12">
            ...
            >
              ...
              <div className="text">
                <span>
                  Wait for the admin to queue you up and return the estimated
                  checkin time for you to arrive with your vehicle
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-4 col-md-12 h-25">
            ...
            >
              ...
              <div className="text">
                <span>
                  After getting your checkin time, arrive at your estimated time
