...
function Packages() {
  ...
  const packageList = useSelector((state) =>
    state.packages.packageList.filter(function (item) {
  ...
  return (
    <div className="container">
      <div className="jumbotron bg-white material-card mt-4">
        <h1 className="display-3" style={{ paddingRight: " 0px" }}>
          Servicing Packages
        </h1>
        <p className="lead">
          Our servicing packages helps to be quick in decision making for the
          kind of servicing you desire!
        </p>
        <p>
          <a
            className="btn btn-lg btn-success col-4"
            href="/login"
            role="button"
          >
            Sign up today
