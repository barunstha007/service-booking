    ...
    <>
      ...
      <div class="jumbotron jumbotron-odi-hero bg-primary">
        <div class="jumbotron-overlay ">
          <div class="container jumbotron-padding  text-center">
            ...
            <p>
              <a
                href="https://www.odipixel.com"
                class="btn btn-lg btn-success btn-circle my-4 mr-3"
              >
                Visit for more
              </a>
            </p>
      ...
      <div class="container mt-5" id="about">
            ...
            <div class="card shadow">
              <div class="card-body">
                <div class="py-3 text-center">
                  {" "}
                  <i
                    class="fas fa-rocket card-img-top fa-4x text-primary"
                    aria-hidden="true"
                  ></i>
                </div>
                <div class="card-body">
                  ...
                  <p class="card-text">
                    You can use this theme as personal as well as for commercial
                    purpose & can customise it.{" "}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="col-md-3">
            <div class="card shadow">
              <div class="card-body">
                <div class="py-3 text-center">
                  <i
                    class="fas fa-feather card-img-top fa-4x text-primary"
                    aria-hidden="true"
                  ></i>
                </div>
                <div class="card-body">
          ...
          <div class="col-md-3">
            <div class="card shadow">
              <div class="card-body">
                <div class="py-3 text-center">
                  <i
                    class="fa fa-tablet card-img-top fa-4x text-primary"
                    aria-hidden="true"
                  ></i>
                </div>
          ...
          <div class="col-md-3">
            <div class="card shadow">
              <div class="card-body">
                <div class="py-3 text-center">
                  <i
                    class="fas fa-charging-station card-img-top fa-4x text-primary"
                    aria-hidden="true"
                  ></i>
                </div>
                <div class="card-body">
        ...
        <div class="container mt-5  text-center">
          <p class="pt-5 pb-2 h4 text-monospace">
            Speed up your development with high quality themes.
          </p>
          <div class="row">
      ...
      <div class="container mt-5">
        <div class="row py-5">
          <div class="col-md-4">
            ...
            <h3 class="mb-0">No hidden charges</h3>
            <p class="lead text-muted">
              We have best suitable plans for your bussiness needs.Money back
              guarantee.
            </p>
            ...
            <div class="card-deck mb-3 text-center">
              <div class="card mb-4 shadow">
                <div class="card-body">
                  ...
                  <button
                    type="button"
                    class="btn btn-lg btn-block btn-outline-primary btn-circle"
                  >
                    Sign up for free
                  </button>
                </div>
              ...
              <div class="card mb-4 shadow">
                <div class="card-body">
                  ...
                  <button
                    type="button"
                    class="btn btn-lg btn-block btn-primary btn-circle"
                  >
                    Get started
                  </button>
                </div>
              ...
              <div class="card mb-4 shadow">
                <div class="card-body">
                  <h3 class="my-3 font-weight-norma text-uppercase">
                    Enterprise
                  </h3>
                  <span class="d-block  text-primary">
                    <span class="align-top">$</span>
              ...
              <div class="card-body">
                <div class="media">
                  <div class="mr-4" style={{ height: "64px", width: "64px" }}>
                    <i
                      class="fa fa-rocket card-img-top fa-4x text-primary"
                      aria-hidden="true"
                    ></i>
                  </div>
            ...
            <div class="card shadow">
              <div class="card-body">
                <div class="media">
                  <div class="mr-4" style={{ height: "64px", width: "64px" }}>
                    <i
                      class="fa fa-leaf card-img-top fa-4x text-primary"
                      aria-hidden="true"
                    ></i>
                  </div>
                  <div class="media-body">
            ...
            <div class="card shadow">
              <div class="card-body">
                <div class="media">
                  <div class="mr-4" style={{ height: "64px", width: "64px" }}>
                    <i
                      class="fa fa-cogs card-img-top fa-4x text-primary"
                      aria-hidden="true"
                    ></i>
                  </div>
                  <div class="media-body">
      ...
      {/* Awesome featured templates */}
      <div class="container mt-5">
        <h3 class="pt-4 d-inline latest-news">Latest News</h3>

        <a
          href=""
          class="btn btn-outline-primary btn-circle d-inline float-right"
        >
          View all
        </a>
        ...
        <div class="row mt-5">
          <div class="col-md-4">
            <div class="card mb-4 shadow-sm">
              ...
              <div class="card-footer text-muted border-0 bg-white"></div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="card mb-4 shadow-sm">
