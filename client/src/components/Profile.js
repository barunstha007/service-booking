    ...
    return (
      ...
      >
          ...
          <div className="col-6 p-1">
            <p>
              <Moment format="MM/D/YYYY, hh:mm">
                {props.bookingDetails.bookingDate}
              </Moment>
            </p>
          </div>
        </div>
        ...
        <div className="row">
          ...
          <div className="col-6 p-1">
            <p>
              {props.bikeModelName}, {props.userBike.bikeNumber}
            </p>
          </div>
        </div>
      </div>
    ...
    return (
      ...
      >
        ...
        <div className="row">
          ...
          <div className="col-6 p-1">
            <p>
              <a href="/bike" className="btn btn-secondary text-white">
                Edit Bike
              </a>
            </p>
          </div>
        ...
        <div className="row">
          ...
          <div className="col-6 p-1">
            <p>
              <span className="text-secondary">Not Booked</span>
            </p>
          </div>
        </div>
        {/* Bike Number */}
...
Profile.propTypes = {
  ...
  sendCompletedRead: PropTypes.func.isRequired,
};
